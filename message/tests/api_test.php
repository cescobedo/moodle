   ...
   public function get_conversations_mixed_provider() {
    ...
    public function test_get_conversation_between_users_with_existing_conversation() {
        ...
        $this->assertEquals($conversationid,
            \core_message\api::get_conversation_between_users([$user1->id, $user2->id, $user3->id]));
    }
    ...
    /**
     * Test create_conversation_between_users with no hash.
     */
    public function test_create_conversation_between_users_with_no_hash() {
        $user1 = self::getDataGenerator()->create_user();
        $user2 = self::getDataGenerator()->create_user();

        $conversationid = \core_message\api::create_conversation_between_users([$user1->id, $user2->id], false);
