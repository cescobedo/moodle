    ...
    public function texts_provider() {
        ...
        return [
            ...
            [$CFG->wwwroot."/lib/tests/fixtures/arithmetic-quiz.h5p?forcedownload=1",
                    "#<iframe src=\"".$CFG->wwwroot."/h5p/embed.php\?url=".rawurlencode($CFG->wwwroot."/lib/tests/fixtures/arithmetic-quiz.h5p")."\"[^>]*?></iframe>#"],
            [$CFG->wwwroot."/pluginfile.php/5/user/private/accordion-6-7138 (1).h5p",
                    "#<iframe src=\"$CFG->wwwroot/h5p/embed.php\?url=".rawurlencode($CFG->wwwroot."/pluginfile.php/5/user/private/accordion-6-7138 (1).h5p")."\"[^>]*?></iframe>#"]
        ];
    }
}